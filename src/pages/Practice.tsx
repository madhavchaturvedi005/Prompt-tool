        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-heading font-semibold mb-4">
              The <span className="text-foreground">Practice Arena</span>
            </h1>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-card border border-border p-6 mb-6">
              ...
              <textarea
                ...
                className="w-full h-40 bg-muted/50 rounded-xl p-4 text-foreground placeholder:text-muted-foreground resize-none focus:outline-none focus:ring-2 focus:ring-foreground/50 transition-all"
              />
