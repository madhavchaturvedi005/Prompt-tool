    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Divider */}
          <div className="h-px w-48 mx-auto mb-6 bg-gradient-to-r from-transparent via-purple-400/60 to-transparent" />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            <Button variant="ocean" size="xl" className="group shadow-xl bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 border-0">
              Begin Your Journey
              <ArrowRight className="w-5 h-5 transition-transform group-hover:translate-x-1" />
            </Button>
            <Button variant="outline" size="xl" className="border-white/30 text-white hover:bg-white/10 bg-white/5 backdrop-blur-sm">
              Explore Curriculum
            </Button>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto">
            {[
              ...
              <div
                key={index}
                className="flex flex-col items-center gap-2 p-6 rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 shadow-lg transition-all duration-300 hover:bg-white/15 hover:scale-105"
              >
