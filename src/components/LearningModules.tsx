          ...
          {modules.map((module, index) => (
            <div
              ...
              className={cn(
                ...
                "hover:border-ocean/40 hover:shadow-xl hover:shadow-ocean/5 cursor-pointer"
              )}
            >
              {/* Icon */}
              <div className="w-12 h-12 flex items-center justify-center border border-ocean/30 mb-6">
                <module.icon className="w-6 h-6 text-ocean" />
              </div>

              {/* Content */}
              <h3 className="text-xl font-serif font-semibold mb-3 group-hover:text-ocean transition-colors">
                {module.title}
              </h3>
